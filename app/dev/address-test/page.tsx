...
export const metadata: Metadata = {
  ...
  description:
    "Development tool for testing address resolution fallback chains",
  robots: {
    index: false,
    follow: false,
  },
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 max-w-2xl">
            Test the address resolution system with comprehensive fallback
            chains including Farcaster, ENS, Web3.bio, and ENSData. Monitor
            cache performance and debug resolution issues.
          </p>
        </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-yellow-200 text-sm">
                This page makes real API calls to external services. Use
                responsibly and be mindful of rate limits. Test results are
        ...
        {/* Simple Address Testing */}
        <div className="bg-gray-900 p-6 rounded-lg">
          <h3 className="text-lg font-medium mb-4">Test Unified Resolution</h3>
          <div className="space-y-4">
            {[
              "0xd8da6bf26964af9d7eed9e03e53415d37aa96045", // vitalik.eth
              "0x55a5705453ee82c742274154136fce8149597058", // papa
              "0x1e17b4fb12b29045b29475f74e536db97ddc5d40", // globalnative.eth
            ].map((address) => (
              <div key={address} className="bg-gray-800 p-4 rounded">
                <div className="text-xs text-gray-400 mb-2">
                  Address: {address}
                </div>
                <Web3Profile address={address} useUnifiedResolution={true} />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mt-12 space-y-6">
            ...
            <div className="bg-gray-900 p-6 rounded-lg">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-300 mt-1">
                    Direct ENS resolution using Ethereum mainnet. Most
                    authoritative for .eth domains.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-900 p-6 rounded-lg">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-300 mt-1">
                    Alternative ENS resolution service with additional metadata
                    and social links.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-gray-900 p-6 rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center space-x-2">
                <span className="w-6 h-6 bg-green-600 rounded-full flex items-center justify-center text-xs">
                  3
                </span>
              ...
              <div className="flex items-center space-x-2">
                <span className="w-6 h-6 bg-orange-600 rounded-full flex items-center justify-center text-xs">
                  5
                </span>
          ...
          <div className="bg-gray-900 p-6 rounded-lg">
            ...
            <div className="space-y-2 text-sm font-mono">
              <div>
                ...
                <span
                  className={
                    process.env.ENABLE_WEB3BIO_FALLBACK !== "false"
                      ? "text-green-400"
                      : "text-red-400"
                  }
                >
              ...
              <div>
                ...
                <span
                  className={
                    process.env.ENABLE_ENSDATA_FALLBACK !== "false"
                      ? "text-green-400"
                      : "text-red-400"
                  }
                >
        ...
        <div className="mt-12 pt-6 border-t border-gray-700 text-center text-gray-500 text-xs">
          <p>Address Resolution Testing Tool - Development Environment Only</p>
          <p className="mt-1">
